...
const MediaControlsBase = kind({
	...
	propTypes: /** @lends agate/MediaPlayer.MediaControls.prototype */ {
		...
		/**
		 * Jump backward [icon]{@link agate/Icon.Icon} name. Accepts any
		 * [icon]{@link agate/Icon.Icon} component type.
		 *
		 * @type {String}
		...
		/**
		 * Jump forward [icon]{@link agate/Icon.Icon} name. Accepts any
		 * [icon]{@link agate/Icon.Icon} component type.
		 *
		 * @type {String}
		 * @default 'nexttrack'
	...
	defaultProps: {
		jumpBackwardIcon: 'previoustrack',
		jumpForwardIcon: 'nexttrack',
		...
		return (
			<OuterContainer {...rest} spotlightId={spotlightId}>
				<Container className={css.mediaControls} spotlightDisabled={spotlightDisabled} onKeyDown={onKeyDownFromMediaButtons}>
					{noJumpButtons ? null : <MediaButton aria-label={$L('Repeat')} backgroundOpacity="transparent" css={css}  disabled={mediaDisabled || playPauseButtonDisabled} icon="repeat" size="large" />}
					{noJumpButtons ? null : <MediaButton aria-label={$L('Shuffle')} backgroundOpacity="transparent" css={css}  disabled={mediaDisabled || playPauseButtonDisabled} icon="shuffle" size="large" />}
					...
					{noJumpButtons ? null : <MediaButton aria-label={$L('List')} backgroundOpacity="transparent" css={css} disabled={mediaDisabled || jumpButtonsDisabled} icon="menu" size="large" spotlightDisabled={spotlightDisabled} />}
				</Container>
				{/*{actionGuideShowing ?*/}
