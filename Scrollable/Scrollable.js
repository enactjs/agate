...
/**
 * An Agate-styled component that provides 5way navigation behavior.
 *
...
class ScrollableBase extends Component {
	...
	render () {
		const
			...
			downButtonAriaLabel = scrollDownAriaLabel == null ? 'scroll down' : scrollDownAriaLabel,
			upButtonAriaLabel = scrollUpAriaLabel == null ? 'scroll up' : scrollUpAriaLabel,
			rightButtonAriaLabel = scrollRightAriaLabel == null ? 'scroll right' : scrollRightAriaLabel,
			leftButtonAriaLabel = scrollLeftAriaLabel == null ? 'scroll left' : scrollLeftAriaLabel;
