...
function PanelWithNav ({children, index, subtitle, onNext, onPrev, ...rest}) {
	return (
...
function App ({defaultIndex = 0, ...rest}) {
	...
	return (
		<Panels {...rest} index={index}>
			...
			<PanelWithNav index={5} onNext={onNext} onPrev={onPrev} hideChildren={false} subtitle="hideChildren=false">
