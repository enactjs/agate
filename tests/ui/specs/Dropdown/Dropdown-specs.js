...
const Page = require('./Agate-Dropdown-Page');
...
describe('Dropdown', function () {
	...
	// 	});
		...
		// });
		//
		// it('should focus the first item when `children` changes to smaller size', function () {
	...
	// 	});
	//
	// 	it('should lock Spotlight inside the Dropdown', function () {
	...
	// 	});
	//
	// 	it('should close dropdown from Pointer mode with Back key', function () {
	// 		const dropdown = Page.components.dropdownDefault;
	//
