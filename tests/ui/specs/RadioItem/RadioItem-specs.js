...
describe('RadioItem', function () {
	...
	describe('default', function () {
		...
		it('should have correct text', async function () {
			expect(await radioItem.textContent).to.equal('Radio Item1');
		});
	...
	describe('default selected', function () {
		...
		it('should have correct text', async function () {
			expect(await radioItem.textContent).to.equal('Radio Item selected');
		});
	...
	describe('inline', function () {
		...
		it('should have correct text', async function () {
			expect(await radioItem.textContent).to.equal('Radio Item inline');
		});
	...
	describe('disabled', function () {
		...
		it('should have correct text', async function () {
			expect(await radioItem.textContent).to.equal('Radio Item disabled');
		});
	...
	describe('inline disabled', function () {
		...
		it('should have correct text', async function () {
			expect(await radioItem.textContent).to.equal('Radio Item inline disabled');
		});
