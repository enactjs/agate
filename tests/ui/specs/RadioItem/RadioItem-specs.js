...
describe('RadioItem', function () {
	...
	describe('inline', function () {
		...
		it('should have correct text', function () {
			expect(radioItem.textContent).to.equal('Radio Item inline');
		});
	...
	describe('disabled', function () {
		...
		it('should have correct text', function () {
			expect(radioItem.textContent).to.equal('Radio Item disabled');
		});
	...
	describe('inline disabled', function () {
		...
		it('should have correct text', function () {
			expect(radioItem.textContent).to.equal('Radio Item inline disabled');
		});
