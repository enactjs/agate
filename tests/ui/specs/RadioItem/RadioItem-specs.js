...
describe('RadioItem', function () {
	...
	describe('default', function () {
		...
		it('should have correct text', async function () {
			expect(await radioItem.textContent).toBe('Radio Item1');
		});
	...
	describe('default selected', function () {
		...
		it('should have correct text', async function () {
			expect(await radioItem.textContent).toBe('Radio Item selected');
		});
	...
	describe('inline', function () {
		...
		it('should have correct text', async function () {
			expect(await radioItem.textContent).toBe('Radio Item inline');
		});
	...
	describe('disabled', function () {
		...
		it('should have correct text', async function () {
			expect(await radioItem.textContent).toBe('Radio Item disabled');
		});
	...
	describe('inline disabled', function () {
		...
		it('should have correct text', async function () {
			expect(await radioItem.textContent).toBe('Radio Item inline disabled');
		});
