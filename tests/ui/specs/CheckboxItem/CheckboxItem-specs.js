...
describe('CheckboxItem', function () {
		...
		describe('default', function () {
			...
			describe('5-way', function () {
				...
				it('should move focus down on 5-way down', async function () {
					...
					expect(await Page.components.checkboxItemDefaultSelected.self.isFocused()).to.be.true();
				});
	...
	describe('RTL locale', function () {
		...
		it('should have focus on first item at start', async function () {
			expect(await Page.components.checkboxItemDefault.self.isFocused()).to.be.true();
		});
