...
const DropdownListBase = kind({
	...
	render: ({children, dataSize, dropdownListClassName, itemSize, scrollTo, groupProps, selected, onSelect, ...rest}) => {

		// delete rest.skinVariants;
		delete rest.width;

		return (
			<div {...rest}  spotlightDisabled={!open} spotlightRestrict="self-only">
											<Scroller
