...
import VideoPlayer, {VideoPlayerBase} from '@enact/agate/VideoPlayer';
import {MediaControls} from '@enact/agate/MediaPlayer';
			...
			return (
				...
				>
					...
					<VideoPlayer
						...
						title={text('title', Config, 'Agate VideoPlayer Sample Video')}
					...
					>
						...
						<MediaControls
							...
							jumpBackwardIcon={select('jumpBackwardIcon', icons, MediaControlsConfig, 'previoustrack')}
							jumpButtonsDisabled={boolean('jumpButtonsDisabled', MediaControlsConfig)}
							jumpForwardIcon={select('jumpForwardIcon', icons, MediaControlsConfig, 'nexttrack')}
