...
const ArcPickerView = () => (
	<>
		<Section horizontal title="Default">
			...
			<ArcPicker alt="With slotCenter" slotCenter="Center">{[1, 2, 3, 4, 5]}</ArcPicker>
		...
		<Section horizontal title="Aria-ValueText">
			...
			<AriaValueTextArcPicker alt="Aria-valuetext with slotCenter" aria-valuetext="This is a Label." slotCenter="Center">{[1, 2, 3, 4, 5]}</AriaValueTextArcPicker>
