...
/**
 * FeedbackTooltip {@link agate/VideoPlayer}. This displays the media's playback rate and
 * time information.
 *
...
const FeedbackTooltipBase = kind({
	...
	propTypes: /** @lends agate/VideoPlayer.FeedbackTooltip.prototype */ {
		/**
		 ...
		 *
		 * This string feeds directly into {@link agate/FeedbackIcon.FeedbackIcon}.
		 *
		 ...
		 * {@link agate/Image} component so it supports all of the same options for the `src`
		...
		/**
		 * Required by the interface for agate/Slider.tooltip but not used here
		 *
		 * @type {Boolean}
		 * @default true
		 * @public
