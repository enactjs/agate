/**
 * Provides Agate-themed video player components.
 *
 * @module agate/VideoPlayer
 * @exports Video
 * @exports VideoPlayer
...
/**
 * Every callback sent by [VideoPlayer]{@link agate/VideoPlayer} receives a status package,
...
/**
 * A player for video {@link agate/VideoPlayer.VideoPlayerBase}.
 *
...
const VideoPlayerBase = class extends React.Component {
	...
	static propTypes = /** @lends agate/VideoPlayer.VideoPlayerBase.prototype */ {
		/**
		 ...
		 * @default agate/MediaPlayer.MediaControls
		 * @public
		 */
		 ...
		 *
		 * Is passed a {@link agate/VideoPlayer.videoStatus} as the first argument.
		 *
		 * @type {Function}
		 * @public
		 */
		 ...
		 *
		 * @type {agate/VideoPlayer.playbackRateHash}
		 * @default {
		 ...
		 * The video source.
		 *
		 * Any children `<source>` tag elements of [VideoPlayer]{@link agate/VideoPlayer} will
		 ...
		 *
		 * This is a standard {@link agate/Image} component so it supports all of the same
		...
		*/
		 ...
		 * * `load()` - load video
		 *
		 * The [`source`]{@link agate/VideoPlayer.Video.source} property is passed to
	 ...
	 *
	 * @function
	 * @memberof agate/VideoPlayer.VideoPlayerBase.prototype
	 * @public
	 */
	showControls = () => {
	 ...
	 * Like [seek]{@link agate/VideoPlayer.VideoPlayer#seek} but relative.
	 *
	 * @function
	 * @memberof agate/VideoPlayer.VideoPlayerBase.prototype
	...
	/**
	 * Changes the playback speed via [selectPlaybackRate()]{@link agate/VideoPlayer.VideoPlayer#selectPlaybackRate}.
	 *
	 * @function
	 * @memberof agate/VideoPlayer.VideoPlayerBase.prototype
	 * @public
	...
	/**
	 * Sets the playback rate type (from the keys of [playbackRateHash]{@link agate/VideoPlayer.VideoPlayer#playbackRateHash}).
	 *
	...
	/**
	 * Changes [playbackRate]{@link agate/VideoPlayer.VideoPlayer#playbackRate} to a valid value
	...
	/**
	 * Sets [playbackRate]{@link agate/VideoPlayer.VideoPlayer#playbackRate}.
	 *
...
/**
 * A standard HTML5 video player for Agate. It behaves, responds to, and operates like a
