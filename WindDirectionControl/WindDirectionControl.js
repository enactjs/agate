...
const WindDirectionControlBase = kind({
	...
	render: ({airDirection, backgroundOpacity, componentIcon, highlightedOpacity, skinVariants, ...rest}) => {
		return (
			<div {...rest}>
				<svg version='1.1' id='bg_ring_wd' xmlns='http://www.w3.org/2000/svg' className={css.windDirectionControlContainer} x='0px' y='0px' viewBox='0 0 300 300' style={{enableBackground: 'new 0 0 300 300'}} >
