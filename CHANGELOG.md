...
- `agate/MediaPlayer` fixed layout issues for Cobalt, Carbon, Copper, Electro, Titanium skins
- `agate/Mediaplayer` fixed shuffle button color for Cobalt, and Copper skins
