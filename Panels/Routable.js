...
/**
 * Default config for [`Routable`]{@link agate/Panels.Routable}.
 *
 * @memberof agate/Panels.Routable
 * @hocconfig
 */
const defaultConfig = {
	/**
	 ...
	 *
	 * This defines the actual name of the [navigate]{@link agate/Panels.Routable#navigate}
	 * property.
	 *
	 * @type {String}
	 * @required
	 * @memberof agate/Panels.Routable.defaultConfig
	 */
	navigate: null
};
...
const Routable = hoc(defaultConfig, (config, Wrapped) => {
	...
	return kind({
		...
		propTypes: /** @lends agate/Panels.Routable.prototype */ {
			/**
