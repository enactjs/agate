...
/**
 * A Router component for use with [`Panels`]{@link agate/Panels.Panels}
 *
 * @class Router
...
const RouterBase = class extends React.Component {
	...
	static propTypes = /** @lends agate/Panels.Router.prototype */ {
		/**
		...
		/**
		 * Called with a reference to [component]{@link agate/Panels.Router#component}.
		 *
		 * @private
		 */
...
/**
 * Used with {@link agate/Panels.Routable} to define the `path` segment and the
 * `component` to render.
 *
...
Route.propTypes = {
	 ...
	 * {@link agate/Panels.Routable} container.
	 *
	 * @type {String|Component}
	 * @required
	 * @public
	 * @memberof agate/Panels.Route.prototype
	 */
