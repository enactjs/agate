...
function fontGenerator (locale) {
	...
	const
		// The font name that will be overridden when in one of the designated locales
		baseFontFamilyName = 'Agate Primary',
	...
	for (let lang in fonts) {
		...
		// Set up the override so "Agate Primary" becomes the local-specific overriding font.
